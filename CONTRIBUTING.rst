...
Before sending your pull requests, make sure you followed this list.
  - Read the `contributing guidelines <https://github.com/giotto-learn/flagser-pybind/blob/master/GOVERNANCE.rst>`_.
  - Read the `code of conduct <https://github.com/giotto-learn/flagser-pybind/blob/master/CODE_OF_CONDUCT.rst>`_.
  - Ensure you have signed the `contributor license agreement (CLA) <https://github.com/giotto-learn/flagser-pybind/blob/master/DEED_OF_CONTRIBUTION.rst>`_.
...
`contributor license agreement (CLA) <https://github.com/giotto-learn/flagser-pybind/blob/master/DEED_OF_CONTRIBUTION.rst>`_.
...
navigate to the `GitHub issue tab <https://github.com/giotto-learn/flagser-pybind/issues`_
